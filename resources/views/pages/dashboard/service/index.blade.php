                                            ...
                                            <td class="w-2/6 px-1 py-5">
                                                <div class="flex items-center text-sm">
                                                    <div class="relative w-10 h-10 mr-3 rounded-full md:block">
                                                        @if (isset($service->thumbnail_service[0]) != null)
                                                            <img class="object-cover w-full h-full rounded" src="{{ Storage::url($service->thumbnail_service[0]->thumbnail) }}" alt="" loading="lazy" />
                                                            <div class="absolute inset-0 rounded-full shadow-inner" aria-hidden="true"></div>
                                                        @else
                                                            <img class="object-cover w-full h-full rounded" src="{{ asset('/storage/assets/service/notfound.png') }}" alt="" loading="lazy" />
                                                        @endif
                                                    </div>
                                                    <div>
